...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_STARTT = 4,                     /* STARTT  */
  YYSYMBOL_END = 5,                        /* END  */
  YYSYMBOL_MONE_KORI = 6,                  /* MONE_KORI  */
  YYSYMBOL_INTEGER = 7,                    /* INTEGER  */
  YYSYMBOL_EQUAL = 8,                      /* EQUAL  */
  YYSYMBOL_JOG = 9,                        /* JOG  */
  YYSYMBOL_PRINT_KORI = 10,                /* PRINT_KORI  */
  YYSYMBOL_TYPE_ASSIGN = 11,               /* TYPE_ASSIGN  */
...
{
       0,    35,    35,    35,    37,    43,    48,    52,    56,    62,
      69,    82,    97,   102,   115,   120,   124,   128
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "FUNC", "STARTT",
  "END", "MONE_KORI", "INTEGER", "EQUAL", "JOG", "PRINT_KORI",
  "TYPE_ASSIGN", "ADDOP", "SUBOP", "MULOP", "DIVOP", "EQUOP", "LT", "GT",
  "LPAREN", "RPAREN", "LBRACE", "RBRACE", "SEMI", "ASSIGN", "ID", "ICONST",
  "INT", "$accept", "program", "$@1", "func_def", "statements",
  "statement", "declaration", "assignment_print_scan", "exp", YY_NULLPTR
};
...
{
     -17,     4,     3,   -17,   -16,   -17,    -1,     1,    15,   -17,
      -5,   -17,    -3,    -2,    16,   -17,   -17,   -17,    14,   -17,
      -9,    19,   -17,   -17,    -7,   -17,    -9,    -9,    -9,    -9,
      13,   -17,    -6,    -6
};
...
{
       2,     0,     0,     1,     0,     3,     0,     0,     0,     6,
       0,     4,     0,     0,     0,     5,     7,     8,     0,    11,
       0,     0,    13,    12,    10,     9,     0,     0,     0,     0,
      14,    15,    17,    16
};
...
{
      11,    12,    26,    26,     3,    13,     4,    27,    27,     6,
      28,    29,    30,    31,    32,    33,    22,    23,     7,     9,
      14,     8,    18,    19,    20,    21,    25,    27
};

static const yytype_int8 yycheck[] =
{
       5,     6,     9,     9,     0,    10,     3,    14,    14,    25,
      17,    18,    26,    27,    28,    29,    25,    26,    19,     4,
      25,    20,    25,    25,     8,    11,     7,    14
};
...
{
       0,    29,    30,     0,     3,    31,    25,    19,    20,     4,
      32,     5,     6,    10,    25,    33,    34,    35,    25,    25,
       8,    11,    25,    26,    36,     7,     9,    14,    17,    18,
      36,    36,    36,    36
};
...
#line 1115 "parser.tab.c"
  ...
  case 3: /* program: $@1 func_def  */
#line 35 "parser.y"
                                         {gen_code(HALT, -1); fprintf(fp_syntax, "program -> func_def\n");}
#line 1121 "parser.tab.c"
    break;

  case 4: /* func_def: FUNC ID LPAREN RPAREN STARTT statements END  */
#line 38 "parser.y"
        {
...
#line 1153 "parser.tab.c"
  ...
  case 8: /* statement: assignment_print_scan  */
#line 57 "parser.y"
            {
...
#line 1161 "parser.tab.c"
  ...
  case 9: /* declaration: MONE_KORI ID TYPE_ASSIGN INTEGER  */
#line 63 "parser.y"
            {
                insert((yyvsp[-2].str_val), (yyvsp[0].int_val));
                fprintf(fp_syntax, "declaration -> MONE_KORI ID TYPE_ASSIGN INTEGER\n");
            }
#line 1170 "parser.tab.c"
    break;

  case 10: /* assignment_print_scan: ID EQUAL exp  */
#line 70 "parser.y"
                {
                    int address = idcheck((yyvsp[-2].str_val));
...
#line 1187 "parser.tab.c"
  ...
  case 11: /* assignment_print_scan: PRINT_KORI ID  */
#line 83 "parser.y"
                {
                    int address = idcheck((yyvsp[0].str_val));
